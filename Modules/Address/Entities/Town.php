...
class Town extends BaseModel
{
    ...
    public function townInfectionReportCollations()
    {
        return $this->hasMany('Modules\Government\Entities\TownInfectionReportCollation');
    }
    public function townHospitalReportCollations()
    {
