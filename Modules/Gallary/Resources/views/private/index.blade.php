    	...
    	<div class="row">
			@foreach(profile()->profileAlbums as $profile_album)
			    <div class="col-sm-4 h4">
		    		...
		    		<a href="#" data-toggle="modal" data-target="#private_{{$profile_album->id}}"><i class="fa fa-folder-open" style="font-size: 180px;"></i>{{$profile_album->album->getName().' '.$profile_album->album->albumContentType->name.' Album'}}
			        </a>
		        </div>
