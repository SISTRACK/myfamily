        ...
        <div class="card-box">
            <div class="row">
                ...
                <div class="col-md-8 col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-6">
                            <h4 class="btn btn-info btn-block ">Health Report</h4>
                            <div class="p-t-10">
                                <div class="row">
                                    @php
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-6">
                            <h4 class="btn btn-info btn-block ">Secrity Report</h4>
                            <div class="p-t-10">
                                <div class="row">
                        ...
                        <div class="col-md-8 col-sm-6">
                            <div class="widget widget-tabs widget-tabs-gray border-bottom-none">
                                ...
                                <div class="widget-heads">
                                    <h4 class="btn btn-info btn-block" href="#educationReport" data-toggle="tab"> Educational Report</h4>
                                </div>
                                <!-- // Widget heading END -->
                                <div class="widget-body">
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="hide"></div>
                                        <div class="p-t-10 tab-pane" id="educationReport">
                                            ...
                                            <div class="row">
                                                ...
                                                @endforeach
                                                <h4 class="btn btn-info btn-block" href="#hide" data-toggle="tab">Hide Report</h4>
                                            </div> 
                                        </div>
                                    </div>
                                </div>
