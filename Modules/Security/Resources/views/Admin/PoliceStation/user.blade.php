<!-- modal -->
<div class="modal fade" id="{{'station_user_'.$station->id}}" role="dialog">
      ...
      <!-- Modal content-->
        <div class="modal-content">
            ...
            <div class="modal-body">
			    <div class="col-md-12">
			         <h2 class="text-primary">New Police Station User Agent</h2>
        <form action="{{route('admin.security.police.station.user.register')}}" method="post">
        	@csrf
        	<input type="hidden" name="police_station_id" value="{{$station->id}}">
