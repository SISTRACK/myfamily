...
class MarriageController extends Controller
{
    ...
    {
        return view('government::Analysis.Social.Marriage.index',['years'=>Year::all(),'months'=>Month::all()]);
    }
    ...
    {
        return view('government::Analysis.Social.Marriage.result',['marriage'=>$marriage->createChart()]);
    }
