...
use Modules\Government\Charts\Health\AdmissionChart;
...
class AdmissionController extends Controller
{
    ...
    {
        return view('government::Analysis.Health.Admission.index',['years'=>Year::all(),'months'=>Month::all()]);
    }
    ...
    {
        return view('government::Analysis.Health.Admission.result',['admission'=>$admission->createChart()]);
    }
