...
use Modules\Government\Charts\Health\HospitalBirthChart;
...
class HospitalBirthController extends Controller
{
    ...
    {
        return view('government::Analysis.Health.HospitalBirth.index',['years'=>Year::all(),'months'=>Month::all()]);
    }
    ...
    {
        return view('government::Analysis.Health.HospitalBirth.result',['birth'=>$birth->createChart()]);
    }
