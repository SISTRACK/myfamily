...
use Modules\Government\Charts\Health\Hospital\InfectionChart;
...
class InfectionController extends Controller
{
    ...
    {
        return view('government::Analysis.Health.Hospital.Infection.index',['years'=>Year::all(),'months'=>Month::all()]);
    }
    ...
    {
        return view('government::Analysis.Health.Hospital.Infection.result',['infection'=>$infection->createChart()]);
    }
