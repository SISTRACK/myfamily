...
use Modules\Government\Charts\Health\Hospital\DischargeChart;
...
class DischargeController extends Controller
{
    ...
    {
        return view('government::Analysis.Health.Hospital.Discharge.index',['years'=>Year::all(),'months'=>Month::all()]);
    }
    ...
    {
        return view('government::Analysis.Health.Hospital.Discharge.result',['discharge'=>$discharge->createChart()]);
    }
