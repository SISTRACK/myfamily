...
use Modules\Government\Charts\Health\Hospital\HospitalDeathChart;
...
class HospitalDeathController extends Controller
{
    ...
    {
        return view('government::Analysis.Health.Hospital.HospitalDeath.index',['years'=>Year::all(),'months'=>Month::all()]);
    }
    ...
    {
        return view('government::Analysis.Health.Hospital.HospitalDeath.result',['death'=>$death->createChart()]);
    }
