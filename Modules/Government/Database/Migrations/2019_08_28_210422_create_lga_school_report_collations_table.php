...
class CreateLgaSchoolReportCollationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('lga_school_report_collations', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('lga_school_report_collations');
    }
}
